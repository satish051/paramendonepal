...
export default function SponsorRoofPage() {
  return (
    <div className="bg-[var(--color-surface)] min-h-screen pb-24">
      {/* Hero Section */}
      <section className="bg-[var(--color-accent)] py-24 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="inline-flex items-center justify-center bg-[var(--color-secondary)]/20 text-[var(--color-secondary)] font-bold px-4 py-2 rounded-full mb-8 border border-[var(--color-secondary)]/30">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-[var(--color-primary)]">Choose Your Impact</h2>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="bg-white rounded-3xl p-10 sm:p-16 border border-gray-100 shadow-sm">
          <h2 className="text-2xl font-bold text-[var(--color-primary)] text-center mb-12">What happens after you sponsor?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
            ...
            <div className="text-center bg-white">
              <div className="w-16 h-16 mx-auto bg-[var(--color-surface)] rounded-full flex items-center justify-center mb-6 border-4 border-white shadow-sm">
