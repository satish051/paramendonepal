  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] py-12">
      <div className="max-w-md mx-auto bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-200">
        <div className="bg-[var(--color-accent)] text-white text-center py-10 px-6 relative">
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-start">
            <MapPin className="w-5 h-5 text-[var(--color-accent)] mr-3 mt-0.5" />
            <div>
          ...
          <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex items-center">
            <Leaf className="w-8 h-8 text-[var(--color-secondary)] mr-4 shrink-0" />
            <div>
