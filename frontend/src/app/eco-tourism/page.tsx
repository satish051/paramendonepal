...
export default function EcoTourismPage() {
  return (
    <div className="min-h-screen bg-[var(--color-offwhite)] py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <Compass className="w-12 h-12 text-[var(--color-leaf)] mx-auto mb-4" />
          <h1 className="text-4xl font-extrabold text-[var(--color-forest)] mb-4">Eco-Tourism & Field Trips</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <button className="w-full bg-[var(--color-forest)] text-white py-3 rounded-xl font-bold flex items-center justify-center">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <button className="w-full bg-white text-[var(--color-forest)] border-2 border-[var(--color-forest)] py-3 rounded-xl font-bold flex items-center justify-center">
