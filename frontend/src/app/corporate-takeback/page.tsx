      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2">
            <div className="inline-flex items-center text-[var(--color-leaf)] font-bold mb-4">
              <Recycle className="w-5 h-5 mr-2" /> B2B Closed-Loop System
            </div>
            <h1 className="text-4xl font-extrabold text-[var(--color-forest)] mb-6">Your Waste. Your Furniture.</h1>
            ...
            <button className="bg-[var(--color-forest)] text-white px-8 py-4 rounded-xl font-bold flex items-center hover:bg-opacity-90">
          ...
          <div className="md:w-1/2 bg-gray-50 p-8 rounded-3xl border border-gray-100">
            ...
            <div className="space-y-6">
              <div className="flex">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center font-bold text-[var(--color-forest)] shadow-sm shrink-0">1</div>
                <div className="ml-4">
              ...
              <div className="flex">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center font-bold text-[var(--color-forest)] shadow-sm shrink-0">2</div>
                <div className="ml-4">
              ...
              <div className="flex">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center font-bold text-[var(--color-forest)] shadow-sm shrink-0">3</div>
                <div className="ml-4">
