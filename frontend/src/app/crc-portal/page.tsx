    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="bg-[var(--color-accent)] text-white p-3 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="md:col-span-2 bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-center">
            <div className="flex items-center text-[var(--color-secondary)] mb-4">
            ...
            <div className="flex space-x-4">
              <button className="bg-[var(--color-accent)] text-white px-6 py-2 rounded-lg font-bold text-sm">Request Payout</button>
              <button className="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg font-bold text-sm">Trade for Goods</button>
            </div>
          </div>

          {/* Current Rates */}
          <div className="bg-[var(--color-accent)] rounded-3xl p-8 text-white shadow-sm flex flex-col justify-center">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900 flex items-center">
              <History className="w-5 h-5 mr-2 text-[var(--color-secondary)]" />
              Recent Deposits
            </h3>
            <button className="text-sm font-bold text-[var(--color-secondary)] flex items-center">
              ...
              <tbody>
                {recentTransactions.map((tx) => (
                  <tr key={tx.id} className="border-b border-gray-50 last:border-0">
                    ...
                    <td className="py-4 font-bold text-[var(--color-primary)] text-right">{tx.credits}</td>
                  </tr>
                ))}
              </tbody>
            </table>
