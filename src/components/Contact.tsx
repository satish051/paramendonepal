              ...
              <div className="flex flex-col sm:flex-row items-start relative z-10">
                ...
                <div className="sm:ml-8">
                  ...
                  <div className="space-y-3">
                    <a href={`mailto:${contactData.email1}`} className="flex items-center text-lg font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
                      {contactData.email1}
                    </a>
                    {contactData.email2 && (
                      <a href={`mailto:${contactData.email2}`} className="flex items-center text-lg font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
                        {contactData.email2}
                      </a>
                    )}
                  </div>
              ...
              <div className="flex space-x-4 sm:space-x-6">
                {contactData.socialLinks?.facebook && (
                  <a 
                    ...
                    aria-label="Facebook"
                    className="w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all duration-300 shadow-sm border border-slate-100 dark:border-slate-800 hover:-translate-y-1"
                  >
                ...
                {contactData.socialLinks?.instagram && (
                  <a 
                    ...
                    className="group w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-[#E1306C] hover:text-white transition-all duration-300 shadow-sm border border-slate-100 dark:border-slate-800 hover:-translate-y-1 relative overflow-hidden"
                  >
                ...
                {contactData.socialLinks?.linkedin && (
                  <a 
                    ...
                    rel="noopener noreferrer" 
                    aria-label="LinkedIn"
                    className="w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-all duration-300 shadow-sm border border-slate-100 dark:border-slate-800 hover:-translate-y-1"
                  >
