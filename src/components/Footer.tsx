    ...
    <footer className="bg-black py-16 px-6 md:px-12 lg:px-20 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-12 lg:col-span-4 space-y-8">
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a href="https://www.facebook.com/ParamendoNepal" target="_blank" rel="noopener noreferrer" className="border border-white/20 rounded-full p-2 text-white/50 hover:text-white hover:border-white/50 transition-colors duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/paramendo_nepal/" target="_blank" rel="noopener noreferrer" className="border border-white/20 rounded-full p-2 text-white/50 hover:text-white hover:border-white/50 transition-colors duration-300">
              ...
              <a href="https://www.linkedin.com/company/paramendo-nepal/" target="_blank" rel="noopener noreferrer" className="border border-white/20 rounded-full p-2 text-white/50 hover:text-white hover:border-white/50 transition-colors duration-300">
          ...
          <div className="md:col-span-4 lg:col-span-2">
            <h3 className="font-heading text-lg tracking-widest uppercase text-white mb-6">
              Explore
            </h3>
            <ul className="space-y-4">
              <li><Link to="/" className="font-body text-sm text-white/60 hover:text-white transition-colors">Home</Link></li>
              <li><Link to="/about" className="font-body text-sm text-white/60 hover:text-white transition-colors">About Us</Link></li>
              <li><Link to="/products" className="font-body text-sm text-white/60 hover:text-white transition-colors">Products</Link></li>
              <li><Link to="/blog" className="font-body text-sm text-white/60 hover:text-white transition-colors">Journal & News</Link></li>
              <li><Link to="/contact" className="font-body text-sm text-white/60 hover:text-white transition-colors">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li><Link to="/sponsor-a-roof" className="font-body text-sm text-white/60 hover:text-white transition-colors inline-flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:ml-0" /> Sponsor a Roof</Link></li>
              <li><a href="https://paramendonepal.vercel.app/certificate" target="_blank" rel="noopener noreferrer" className="font-body text-sm text-white/60 hover:text-white transition-colors inline-flex items-center group"><ArrowRight className="w-3 h-3 mr-2 opacity-0 -ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:ml-0" /> ESG Certificates</a></li>
          ...
          <div className="md:col-span-8 lg:col-span-3">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-white font-medium mb-1 font-body text-sm">Location</h4>
                  <div className="text-sm font-body text-white/70 leading-relaxed">
                    <p className="mb-1">HQ & Community Center</p>
                    {content.location}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="w-full overflow-hidden">
                  <h4 className="text-white font-medium mb-1 font-body text-sm">Email Us</h4>
                  <div className="flex flex-col space-y-2 text-sm font-body">
                    <a href={`mailto:${content.email1}`} className="text-white/60 hover:text-white transition-colors truncate block" title={content.email1}>{content.email1}</a>
                    <a href={`mailto:${content.email2}`} className="text-white/60 hover:text-white transition-colors truncate block" title={content.email2}>{content.email2}</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="pt-8 mt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-sm font-body text-white/40 text-center md:text-left">
            © {new Date().getFullYear()} <span className="text-white font-semibold tracking-wide">Paramendo Nepal</span>. All rights reserved.
          </p>
          <div className="flex flex-wrap justify-center md:justify-end items-center gap-x-8 gap-y-4 text-sm font-body">
            ...
            <Link to="/login" className="text-white/60 hover:text-white transition-colors">Admin</Link>
          </div>
        </div>
      </div>
    </footer>
